...
public class TransactionController {
    ...
    public ResponseEntity makeTransaction(
        ...
        if (amount == null || description == null || accountFromNumber == null || toAccountNumber == null || authentication != null) {//luego verificamos cual es el faltante y damos la respuesta
